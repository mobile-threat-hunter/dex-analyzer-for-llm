...
def _wrap(tool_name: str) -> Callable[..., str]:
    """Build an MCP-callable for ``tool_name``.

    The callable opens DexKit from apk_path and dispatches through
    dexllm.tools.execute.
    """
